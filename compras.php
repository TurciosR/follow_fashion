    ...
    <div class="wrapper wrapper-content  animated fadeInRight">
      <div class="row">
              ...
              <div class="ibox-content">
                ...
                <div class='row'>
                    ...
                    <div class='form-group has-info'>
                      ...
                      <select class="form-control select " id="id_proveedor" name="id_proveedor">
                        ...
                        while ($row=_fetch_array($sql_proveedor)) {
                          # code...
                          ?>
                          <option <?php if($row['id_proveedor']==$id_proveedor){echo " selected ";
                            $percibe=$row['percibe'];
                            if ($percibe==1) {
                  ...
                  <div class='col-lg-3'>
                    <div class='form-group has-info'>
                      ...
                      <select class="form-control select " id="tipo_doc" name="tipo_doc">
                        <option <?php if($tipo_documento=="CCF"){echo " selected ";} ?>   value="CCF">CREDITO FISCAL</option>
                        <option <?php if($tipo_documento=="COF"){echo " selected ";} ?>   value="COF">CONSUMIDOR FINAL</option>
                      </select>
                    </div>
                  </div>
                  <div class='col-lg-3'>
                  ...
                  <div class='col-lg-2'>
                    <div class='form-group has-info'>
                      <label>Fecha</label>
                      <input type='text' class='datepick form-control' value='<?php if($fecha!=""){ echo $fecha;}else{ echo $fecha_actual;} ?>' id='fecha1' name='fecha1'>
                    </div>
                  </div>
                </div>
                        ...
                        <div class="table100 ver1 m-b-10">
                          ...
                          <div class="table100-body js-pscroll">
                            <table>
                              <tbody id="inventable">
                                <?php
                                $sql_cd= _query("SELECT detalle_compra2.subtotal, detalle_compra2.cantidad,presentacion_producto.precio, presentacion_producto.descripcion as descrip,presentacion_producto.unidad,presentacion_producto.id_pp,producto.perecedero,producto.descripcion,producto.id_producto,producto.exento,producto.id_categoria,detalle_compra2.fecha_vence,detalle_compra2.ultcosto,detalle_compra2.id_presentacion FROM detalle_compra2 JOIN producto ON producto.id_producto=detalle_compra2.id_producto JOIN presentacion_producto ON presentacion_producto.id_pp=detalle_compra2.id_presentacion WHERE detalle_compra2.id_compra=$id_compra");
                                $tr_add = "";
        ...
        function consultar_stock()
        {
          ...
          $sql1 = "SELECT p.id_producto, p.descripcion,p.exento
          FROM producto AS p
          WHERE $clause";
