  ...
  $decimals=$row["decimals"];
	...
	<div class="wrapper wrapper-content  animated fadeInRight">
		<div class="row">
                    ...
                    <button style="margin:0px;" type="button" class="btn btn-danger pull-right" name="button"> <i class="fa  fa-mail-reply"></i> Salir</button>
						...
						<div class="ibox-content">
								...
								<div class="row">
									<div class="col-md-3">
										<div class="form-group has-info single-line">
											<label class="control-label">Frágil </label>
											<?php
											if($eval==1)
											{
												echo "<div class='checkbox i-checks'><label> <input type='checkbox'  id='eval' name='eval' value='1' checked> <i></i>  </label></div>";
											}
											else
											{
												echo "<div class='checkbox i-checks'><label> <input type='checkbox'  id='eval' name='eval' value='1'> <i></i>  </label></div>";
											}
											?>
										</div>
									</div>
			...
			<?php
			include 'footer.php';
			  echo "<script src='js/funciones/funciones_producto.js?t".rand(0,9999)."=".rand(0,9999)."'></script>";
		} //permiso del script
		else {
    ...
    _begin();
    $id_presentacion=$_REQUEST['id_presentacion'];
    _query("UPDATE presentacion_producto set id_producto=-id_producto where id_pp= $id_presentacion");
    if (true) {
      // code...
      _commit();
      $xdatos['typeinfo']="Success";
