...
$id_sucursal=$_SESSION['id_sucursal'];
$joinQuery ="  FROM credito LEFT JOIN cliente ON cliente.id_cliente=credito.id_cliente LEFT join factura as fac on fac.id_factura=credito.id_factura";
...
$columns = array(
  ...
  array( 'db' => 'CONCAT(cliente.nombre,"")', 'dt' => 2, 'field' => 'cnr', 'as' =>'cnr'),
  array( 'db' => '`credito`.`numero_doc`', 'dt' =>3, 'field' => 'numero_doc' ),
