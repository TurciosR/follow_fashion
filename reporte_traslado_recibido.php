...
JOIN presentacion_producto ON presentacion_producto.id_pp=traslado_detalle_recibido.id_presentacion
JOIN presentacion ON presentacion.id_presentacion=presentacion_producto.id_presentacion WHERE traslado_detalle_recibido.id_traslado=$id_traslado");
