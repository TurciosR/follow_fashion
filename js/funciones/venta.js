...
$(document).on("keyup","#efectivov",function(evt){
	...
	else
	{
		...
		{
			display_notify("Warning", "Debe finalizar la  factura primero para poder imprimir no se tomara en cuenta en las ventas ni se descargara de inventario si no finaliza la venta en curso");
      $("#cambiov").val("");
      $("#efectivov").val("");
