...
function initial()
{
	...
	<div class="wrapper wrapper-content  animated fadeInRight">
						...
						<div class="ibox-content">
							<form name="formulario" id="formulario">
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group has-info single-line">
											<label>Negocio o Referencia </label>
											<input type="text" placeholder="Nombre del negocio" class="form-control" id="referencia" name="referencia" value="<?=$datos['referencia'] ?>">
										</div>
									</div>
									<div class="col-lg-12">
										<div class="form-group has-info single-line">
		...
		echo "<script src='js/funciones/funciones_cliente.js?t".rand(0,9999)."=".rand(0,9999)."'></script>";
	} //permiso del script
	else
	{
