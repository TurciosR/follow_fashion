                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
	                               ...
	                               <div class="form-group">
																	 ...
																	 <select style='width:100%' id="id_ubicacion" name="id_ubicacion">
																		 <option value="0">GENERAL</option>
																		 <?php
																		 $sql_ubi = _query("SELECT * FROM ubicacion where borrado=0");
																		 while ($row_u = _fetch_array($sql_ubi)) {
																		 	// code...
																			?>
																			<option value="<?=$row_u['id_ubicacion'] ?>"><?=$row_u['descripcion'] ?></option>
																			<?php
																		 }
																		  ?>
																	 </select>
                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <input  type="button" id="submit2" name="submit1" value="EXCEL" class="btn btn-primary m-t-n-xs" />
                                </div>
                              </div>
                            </div>
                        </div>
...
$(document).on('click', '#submit1', function(event) {
	...
	var cadena = "reporte_inventario_pdf.php?id_ubicacion="+id_ubicacion;
	window.open(cadena, '', '');
});
$(document).on('click', '#submit2', function(event) {
	event.preventDefault();
	var id_ubicacion = $("#id_ubicacion").val();
	var cadena = "reporte_inventario_xls.php?id_ubicacion="+id_ubicacion;
	window.open(cadena, '', '');
});
