              ...
              <div class="ibox-content">
                ...
                <div class="row focuss"><br>
                  ...
                  <div class="col-md-7"><br>
                    ...
                    <a class="btn btn-sm btn-warning pull-right" style="margin-left:1%;" id='abrir'><i class="fa fa-check"></i> Abrir</a>
                ...
                <div class="form-group has-info">
                  ...
                  <select class="form-control select usage" name="id_cliente" id="id_cliente">
                    ...
                    while ($row_cli = _fetch_array($sqlcli))
                    {
                      ...
                      echo ">".$row_cli["nombre"].". ".$row_cli['referencia']."</option>";
                    } ?>
                  </select>
                </div>
              </div>
  ...
  if ($count_fact > 0) {
    ...
    while ($row_cli = _fetch_array($sqlcli)) {
      if ($row_cli["id_cliente"]==$id_cliente) {
        # code...
        $select_cliente.= "<option value='".$row_cli["id_cliente"]."' selected>".$row_cli["nombre"].". ".$row_cli['referencia']."</option>";
      } else {
        $select_cliente.= "<option value='".$row_cli["id_cliente"]."'>".$row_cli["nombre"].". ".$row_cli['referencia']."</option>";
      }
    }
...
function insertar()
{
  ...
  if ($cuantos>0) {
    ...
    if ($a&&$b&&$c&&$x&&$z&&$k&&$j&&$l&&$cre) {
      ...
      $xdatos['nombre']=$row_cli["nombre"].". ".$row_cli["referencia"];
